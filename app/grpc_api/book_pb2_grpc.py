...
class BookServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetBooks = channel.unary_unary(
                ...
                request_serializer=book__pb2.BookFilter.SerializeToString,
        ...
        self.UpdateBook = channel.unary_unary(
                ...
                request_serializer=book__pb2.UpdateRequest.SerializeToString,
                response_deserializer=book__pb2.Book.FromString,
                _registered_method=True)
        self.DeleteBook = channel.unary_unary(
                '/book.BookService/DeleteBook',
                request_serializer=book__pb2.DeleteRequest.SerializeToString,
                response_deserializer=book__pb2.DeleteResponse.FromString,
                _registered_method=True)
...
def add_BookServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetBooks': grpc.unary_unary_rpc_method_handler(
                    servicer.GetBooks,
                    request_deserializer=book__pb2.BookFilter.FromString,
            ...
            'UpdateBook': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateBook,
                    request_deserializer=book__pb2.UpdateRequest.FromString,
                    response_serializer=book__pb2.Book.SerializeToString,
            ),
            'DeleteBook': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteBook,
                    request_deserializer=book__pb2.DeleteRequest.FromString,
                    response_serializer=book__pb2.DeleteResponse.SerializeToString,
            ),
    }
...
class BookService(object):
    ...
    def GetBooks(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/book.BookService/GetBooks',
            book__pb2.BookFilter.SerializeToString,
    ...
    def UpdateBook(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/book.BookService/UpdateBook',
            book__pb2.UpdateRequest.SerializeToString,
            book__pb2.Book.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def DeleteBook(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/book.BookService/DeleteBook',
            book__pb2.DeleteRequest.SerializeToString,
            book__pb2.DeleteResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
